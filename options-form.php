...
if($_POST['menu_item_changer']){
	echo "<h1 class='success_change'>".$_POST['menu_item_changer']." updated</h1>";
	//exit();

$_SESSION["the_page"] = $_POST['menu_item_changer'];
...
function add_specific_menu_attsq( $atts, $item, $args ) {
		...
		foreach ($primaryNav as $menu_item) {
			...
			if($menu_item->post_title==$_SESSION["the_page"]){
